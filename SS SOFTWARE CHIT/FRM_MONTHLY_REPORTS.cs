...
{
    public partial class FRM_MONTHLY_REPORTS : Form
    {
        ...
        public FRM_MONTHLY_REPORTS(WhatsApp whatsappInitialize)
        {
            InitializeComponent();
            try
            {
        ...
        private void FRM_MONTHLY_REPORTS_Load(object sender, EventArgs e)
        {
        ...
        private void Pdf()
        {
            ...
            {
                CRY_MONTHLY_REPORTS cr = new CRY_MONTHLY_REPORTS();
                FRM_CRY_MONTHLY_REPORTS Print = new FRM_CRY_MONTHLY_REPORTS();
                DataSet ds = new DataSet();
                ...
                cr.ExportToDisk(CrystalDecisions.Shared.ExportFormatType.PortableDocFormat, "" + Application.StartupPath + "\\REPORTS\\" + "MONTHLY REPORTS " + txtfromdate.Value.ToString("dd-MM-yyyy") + " TO " + txttodate.Value.ToString("dd-MM-yyyy") + ".pdf");
            }
        }
        ...
        private void btnprint_Click(object sender, EventArgs e)
        {
            ...
            {
                CRY_MONTHLY_REPORTS cr = new CRY_MONTHLY_REPORTS();
                FRM_CRY_MONTHLY_REPORTS View_Monthly_Reports = new FRM_CRY_MONTHLY_REPORTS();
                DataSet ds = new DataSet();
                DataTable dt = new DataTable();
                ...
                ds.WriteXmlSchema("Reports.xml");
                cr.SetDataSource(ds);
                View_Monthly_Reports.View_Report.ReportSource = cr;
                cr.PrintOptions.PaperOrientation = CrystalDecisions.Shared.PaperOrientation.Portrait;
                cr.PrintOptions.PaperSize = CrystalDecisions.Shared.PaperSize.PaperA4;
        ...
        private void Excel()
        {
            ...
            else
            {
                ...
                cr.PrintOptions.PaperOrientation = CrystalDecisions.Shared.PaperOrientation.Portrait;
                cr.PrintOptions.PaperSize = CrystalDecisions.Shared.PaperSize.PaperA4;
                cr.ExportToDisk(CrystalDecisions.Shared.ExportFormatType.Excel, "" + Application.StartupPath + "\\REPORTS\\" + "MONTHLY REPORTS " + txtfromdate.Value.ToString("dd-MM-yyyy") + " TO " + txttodate.Value.ToString("dd-MM-yyyy") + ".xls");
            }
        }
        ...
        private async void btnmailsender_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (txtemail.Text != "")
                {
                    ...
                    Excel();
                    string pdfMail = Path.Combine(Application.StartupPath, "REPORTS", "MONTHLY REPORTS " + txtfromdate.Value.ToString("dd-MM-yyyy") + " TO " + txttodate.Value.ToString("dd-MM-yyyy") + ".pdf");
                    string XlsMail = Path.Combine(Application.StartupPath, "REPORTS", "MONTHLY REPORTS " + txtfromdate.Value.ToString("dd-MM-yyyy") + " TO " + txttodate.Value.ToString("dd-MM-yyyy") + ".xls");
                    ...
                    if (connection)
                    {
                        using (SmtpClient Client = new SmtpClient("smtp.gmail.com"))
                        {
                            ...
                            using (MailMessage Message = new MailMessage())
                            {
                                ...
                                Message.Subject = "Monthly Chit Billing Report - " + txtfromdate.Value.ToString("dd-MM-yyyy") + " TO " + txttodate.Value.ToString("dd-MM-yyyy");
                                string emailBody = @"
  <!DOCTYPE html>
    <html>
    <head>
    ...
    <body>
        <div class='container'>
            ...
            <div class='content'>
                ...
                <p>We're thrilled to share this Month's Chit Billing Report with you. It's been an exciting day, and we want to keep you in the loop.</p>
