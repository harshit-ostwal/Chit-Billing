...
namespace SS_SOFTWARE_CHIT
{
    ...
    public partial class FRM_CALCULATOR : Form
    {
        ...
        public FRM_CALCULATOR(WhatsApp whatsappInitialize)
        {
            InitializeComponent();
            try
            {
        ...
        {
            if (MessageBox.Show("DO YOU WANT TO CLEAR???", "SS SOFTWARE", MessageBoxButtons.YesNo, MessageBoxIcon.Question) == DialogResult.Yes)
            {
